...
What has been compared, state by state. "AX" = Mac accessibility tree read; "cap" = capture; "src" = Lulo read from source only (the laptop session ended mid-audit, see Settings rows); "—" = not checked.
