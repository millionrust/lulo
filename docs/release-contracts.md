...
A4 report, update trust, hardware, journey, visual, accessibility, performance,
chaos/soak, security, documentation, Alpha, Beta, and 1.0 structural
validators.
...
Use `--list` to inspect the exact 14 stages. The committed manifest and runner
