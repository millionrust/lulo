...
impl NotesView {
    ...
    pub(super) fn apply_preview_event(
        &mut self,
        bridged: PreviewBridgeEvent,
        cx: &mut Context<Self>,
    ) {
    ...
    pub(super) fn apply_markdown_preview_event(
        &mut self,
    ...
    pub(super) fn request_markdown_preview_shutdown(&mut self, cx: &mut Context<Self>) -> bool {
    ...
    pub(super) fn request_preview_shutdown(&mut self, cx: &mut Context<Self>) -> bool {
