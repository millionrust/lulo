//! Bounded external icon decoding for the Dock renderer.
//!
...
fn decode_png(bytes: &[u8], request: DecodeRequest) -> Result<DecodedIcon, Error> {
    ...
    raster_to_square(decoded, request, SourceFormat::Png)
}
