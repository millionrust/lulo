...
3. Shell rendering still lives partly in `experiments/gpui-upstream-lab`. The
   selected framework path must become the maintained packaged product rather
   than a permanently separate preview implementation.
