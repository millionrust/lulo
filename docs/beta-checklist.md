...
|---|---|---|---|
| 1 | Journey 5 has a confirmed functional failure: Save on an Untitled Text Editor document does not present a proper Save panel (3/4 scenarios pass), and `rmac-file-chooser` is not deployed on the reference laptop. | agent | M |
