...
- `rmac-network` — NetworkManager/macOS Wi-Fi state, scanning, radio control, exact activation/forgetting, Known Networks, and one-shot WPA Personal/SAE secret delivery.
