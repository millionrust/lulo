...
What has been compared, Mac vs Lulo. "Live" means reached on the machine; "source" means read from dev code only. Lulo live checks used dev 2ba73bb9 app binaries on the reference laptop (the installed menu bar is older).
