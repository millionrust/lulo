//! Network IP, DNS, and proxy editor lifecycle.

use super::*;

impl Settings {
    pub(in crate::controller) fn start_network_edit(
        &mut self,
        interface: String,
    ...
    pub(in crate::controller) fn set_network_ip_method(
        &mut self,
    ...
    pub(in crate::controller) fn set_network_ignore_auto_dns(
        &mut self,
        family: rmac_network::IpFamily,
        value: bool,
        cx: &mut Context<Self>,
    ...
    pub(in crate::controller) fn set_network_proxy_method(
        &mut self,
    ...
    pub(in crate::controller) fn set_network_proxy_browser_only(
        &mut self,
        value: bool,
        cx: &mut Context<Self>,
    ) {
    ...
    pub(in crate::controller) fn cancel_network_edit(&mut self, cx: &mut Context<Self>) {
        if !self.network_busy {
    ...
    pub(in crate::controller) fn submit_network_edit(&mut self, cx: &mut Context<Self>) {
