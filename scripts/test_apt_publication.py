...
class ReleaseHistoryTests(PublicationTestCase):
    ...
    def test_a_new_release_carries_an_unchanged_niri_forward_byte_for_byte(self):
        # v1.0.1 rebuilds niri 26.04+lulo1-1 with different bytes; the pool is
        ...
        niri = "pool/main/n/niri/niri_26.04+lulo1-1_amd64.deb"
        self.assertEqual(
        ...
        self.assertEqual(packages["niri"], "26.04+lulo1-1")
    ...
    def test_only_the_newest_snapshots_are_retained(self):
        ...
        self.assertTrue((repository / "pool/main/n/niri/niri_26.04+lulo1-1_amd64.deb").exists())
...
class RealKeySigningTests(unittest.TestCase):
    ...
    def test_apt_itself_accepts_the_signed_repository(self):
        ...
        with tempfile.TemporaryDirectory() as temporary:
            ...
            self.assertIn("niri (>= 26.04+lulo1-1)", record["Depends"])
