...
pub struct ColorTokens {
    ...
    pub system_blue: RgbaColor,
    pub system_purple: RgbaColor,
    pub system_pink: RgbaColor,
    pub system_red: RgbaColor,
    pub system_orange: RgbaColor,
    pub system_yellow: RgbaColor,
    pub system_green: RgbaColor,
    pub system_teal: RgbaColor,
    pub system_indigo: RgbaColor,
    pub system_brown: RgbaColor,
    pub system_gray: RgbaColor,
    ...
    pub scrim: RgbaColor,
    pub info_table_stripe: RgbaColor,
    pub notes_accent: RgbaColor,
    pub notes_selection: RgbaColor,
    pub folder_blue: RgbaColor,
...
impl ThemeTokens {
    ...
    pub fn from_appearance_with_wallpaper(
        ...
        let colors = ColorTokens {
            ...
            system_blue: design.colors.system_blue.into(),
            system_purple: design.colors.system_purple.into(),
            system_pink: design.colors.system_pink.into(),
            system_red: design.colors.system_red.into(),
            system_orange: design.colors.system_orange.into(),
            system_yellow: design.colors.system_yellow.into(),
            system_green: design.colors.system_green.into(),
            system_teal: design.colors.system_teal.into(),
            system_indigo: design.colors.system_indigo.into(),
            system_brown: design.colors.system_brown.into(),
            system_gray: design.colors.system_gray.into(),
