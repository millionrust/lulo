...
A4 report, update trust, atomic APT publication, hardware, foundation evidence, journey, visual,
...
Use `--list` to inspect the exact 16 stages. The committed manifest and runner
