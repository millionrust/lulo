...
The live `org.rmac.Focus1` and `org.rmac.NotificationCenter1` authorities now
publish separately from preferences. Both reconnecting clients establish their
