...
- Native hardware, final shell presentation, accessibility, visual,
  ...
  remains open. See [Known limitations](known-limitations.md).
...
application. See [`docs/gpui-0.2.2-stable-spike.md`](gpui-0.2.2-stable-spike.md).
...
See [`docs/gpui-current-upstream-spike.md`](gpui-current-upstream-spike.md)
...
[`docs/performance-baseline.md`](performance-baseline.md) for the committed
macOS baseline, method, known failures, and remaining Linux/frame-time evidence.

## Documentation

- [`docs/user-guide.md`](user-guide.md) — everyday desktop and application guide.
- [`docs/install.md`](install.md) — honest contributor/test installation boundary.
- [`docs/hardware-support.md`](hardware-support.md) — intended hardware matrix and current claims.
- [`docs/settings-guide.md`](settings-guide.md) — user-facing System Settings guide.
- [`docs/shortcuts.md`](shortcuts.md) — global and application keyboard conventions.
- [`docs/privacy.md`](privacy.md) — local data, permissions, credentials, and diagnostics.
- [`docs/troubleshooting.md`](troubleshooting.md) — recovery, safe mode, logs, and issue reports.
- [`docs/session-recovery.md`](session-recovery.md) — redacted diagnostics, known-good settings restore, and TTY recovery.
- [`docs/session-journey-evidence.md`](session-journey-evidence.md) — real GDM, crash-loop, safe-mode, TTY, and GNOME evidence.
- [`docs/update-and-remove.md`](update-and-remove.md) — updates, rollback, uninstall, and data retention.
- [`docs/release-notes.md`](release-notes.md) — current unreleased product status.
- [`docs/alpha-contributor-build.md`](alpha-contributor-build.md) — contributor Alpha publish and issue-intake boundary.
- [`docs/beta-cohort.md`](beta-cohort.md) — invited daily-driver Beta safety and cohort boundary.
- [`docs/one-dot-zero-candidate.md`](one-dot-zero-candidate.md) — two-build full-matrix 1.0 promotion boundary.
- [`docs/release-contracts.md`](release-contracts.md) — fast build-free integrity gate for release definitions.
- [`docs/linux-foundation-report.md`](linux-foundation-report.md) — privacy-safe A1–A4 handoff into the framework decision.
- [`docs/keyring-packaging.md`](keyring-packaging.md) — reproducible package-managed APT trust anchor and source offer.
...
- [`docs/phase-0-inventory.md`](phase-0-inventory.md) — starting technical-debt inventory.
- [`docs/performance-baseline.md`](performance-baseline.md) — reproducible startup, idle CPU, and RSS evidence.
- [`docs/dependency-policy.md`](dependency-policy.md) — advisory, license, dependency, and source rules.
- [`docs/linux-reference-bringup.md`](linux-reference-bringup.md) — reference-PC setup, automated evidence, and Phase 1 manual gates.
- [`docs/system-settings-audit.md`](system-settings-audit.md) — real-service status and completion contract for every Settings pane.
- [`docs/decisions/0001-gpui-linux-gate.md`](decisions/0001-gpui-linux-gate.md) — framework migration gate.
- [`docs/decisions/0002-gpui-version-policy.md`](decisions/0002-gpui-version-policy.md) — exact pins, upgrade cadence, promotion, and rollback policy.
- [`docs/gpui-current-upstream-spike.md`](gpui-current-upstream-spike.md) — pinned upstream comparison and pending Linux gates.
- [`docs/wallpaper.md`](wallpaper.md) — wallpaper authority, sources, geometry, decoding, and runtime contract.
- [`docs/decisions/0003-wallpaper-portal-authority.md`](decisions/0003-wallpaper-portal-authority.md) — session versus XDG portal wallpaper ownership.
- [`docs/decisions/0004-secure-lock-boundary.md`](decisions/0004-secure-lock-boundary.md) — compositor, PAM, logind, and crash-recovery ownership for locking.
- [`docs/decisions/0006-shell-and-app-framework-split.md`](decisions/0006-shell-and-app-framework-split.md) — shell on the pinned upstream GPUI layer-shell revision, apps on 0.2.2.
